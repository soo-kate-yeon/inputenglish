...
#### R-AI-007: AI 기능 플랜 제한 (State-Driven)
...
| R-AI-007 | AI/PAY | useSubscription |
...
3. **Supabase Plan Sync on Expiry**: SDK provides expiry events; Supabase sync confirmed working on purchase, not yet verified on expiry edge case
...
1. **Expiry Edge Case**: Verify and test Supabase plan sync on subscription expiry
2. **Physical Device Testing**: Test full purchase flow on iOS/Android devices
