...
const INTRO_MEDIA_URIS = [
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_1.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_2.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_3.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_4.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_5.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_6.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_7.png"))
    .uri,
  Asset.fromModule(require("../../assets/images/onboarding/onboarding_8.png"))
    .uri,
] as const;
