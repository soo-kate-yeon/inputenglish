...
Complementary skills include moai-docs-generation for auto-generating docs from code, moai-workflow-docs for validating documentation quality, and moai-cc-Codex-md for Markdown formatting.

---

## Version History

Version 2.2.0 released 2026-01-11 removes code blocks to comply with AGENTS.md Documentation Standards and converts all examples to narrative descriptions.
