...
description: >
  Enterprise Mermaid diagramming skill for Codex using MCP Playwright. Use when
...
Mermaid Diagram Expert v7.1.0 - Pure skill-based Mermaid rendering for Codex with MCP Playwright integration.
...
This skill is designed for use within Codex during various development phases:
