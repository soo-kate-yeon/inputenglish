...
- `GEMINI_API_KEY` — Gemini 2.5 Pro/Flash (읽기 생성 + 질문 에이전트)
- `AZURE_OPENAI_ENDPOINT` / `AZURE_OPENAI_API_KEY` / `AZURE_OPENAI_DEPLOYMENT` / `AZURE_OPENAI_API_VERSION` — 읽기 생성 Azure 폴백 (선택)
- `YT_DLP_PATH` — 영상 인제스트 (관리자 기능, 선택)
